            ...
            return (
              <AnimatedCard key={service.slug}>
                <Link
                  ...
                  className="group relative flex flex-col rounded-xl border border-border bg-card overflow-hidden transition-all hover:shadow-lg hover:border-foreground/20 h-full"
                >
